...
export default function ModulesControls({ moduleName, setModuleName, addModule }: { moduleName: string; setModuleName: (title: string) => void; addModule: () => void; }) {
  ...
  return (
   <div id="wd-modules-controls" className="text-nowrap">
     ...
     <Button variant="secondary" id="wd-view-progress" className="text-nowrap float-end me-2" size="lg">
        View Progress
     </Button>
     <Button  variant="secondary" id="wd-collapse-all" className="me-1 float-end" size="lg">
        Collapse All
     </Button>
