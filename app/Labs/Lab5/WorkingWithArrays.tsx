...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <FormControl as="textarea" defaultValue={todo.description} className="" onChange={(e) => setTodo({ ...todo, title: e.target.value })} />
            ...
            <FormControl defaultValue={todo.id} className="w-25 float-start me-2" onChange={(e) => setTodo({ ...todo, id: e.target.value})} />
            <FormCheck defaultChecked={todo.completed} onChange={(e) => setTodo({ ...todo, completed: e.target.checked})} />
            <br /><br /><hr />
