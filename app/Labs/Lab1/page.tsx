    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                My favorite recipe:
                <ol>
                    <li>Dice your chicken breast into small cubes</li>
                    <li>Put the chicken in a bowl with all the spices</li>
                    <li>Mix the spices into chicken well</li>
                    <li>Heat pan on stove and put butter in the pan</li>
                    <li>Once Pan is hot, put chicken in and cook</li>
                    <li>Once cooked, turn down the heat and add honey to simmer</li>
                    <li>Simmer for 3 minutes</li>
                    <li>Wait until cool and Enjoy</li>
                </ol>
            ...
            <div id="wd-tables">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Q7</td>
                        <td>React State and Redux</td>
                        <td>3/17/21</td>
                        <td>75</td>
                    </tr>
                    <tr>
                        <td>Q8</td>
                        <td>React State in Kambaz</td>
                        <td>3/24/21</td>
                        <td>85</td>
                    </tr>
                    <tr>
